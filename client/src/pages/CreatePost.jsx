		...
		<section className='max-w-7xl mx-auto'>
			<div>
				...
				<p className='mt-2 text-[#666e75] text-[14px] max-w-[500px]'>
					Browse through a collection of imaginative and visually stunnig images generated through ALL-E AI and share them with
					community
				</p>
			</div>
			<form className='mt-16 max-w-xl' onSubmit={handleSubmit}>
				<div className='flex flex-col gap-5'>
					...
					<div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-300 w-64 p-3 h-64 flex justify-center items-center '>
						{form.photo ? (
